...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # We use a new browser session to ensure none of Edith's
        # data are served from cookies etc
        self.browser.quit()
        self.browser = webdriver.Chrome()
        ...
        # Francis starts his own new list.
        ...
        # Satisfied both of them go to sleep
